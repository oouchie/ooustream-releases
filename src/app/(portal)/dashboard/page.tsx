    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Link href="/billing" className="card card-hover text-center">
            <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-[#00d4ff]/20 flex items-center justify-center">
              <svg
            ...
            <h3 className="font-medium text-[#f1f5f9]">Billing</h3>
            <p className="text-sm text-[#94a3b8] mt-1">Payment & invoices</p>
          </Link>
