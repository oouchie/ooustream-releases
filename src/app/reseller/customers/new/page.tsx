          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="md:col-span-2 flex items-start gap-3 mt-1">
              ...
              <label htmlFor="sms_consent" className="text-sm text-[#94a3b8] leading-snug">
                Customer agrees to receive account notification SMS from OOUStream — subscription renewal reminders and service notifications (outages, maintenance). Up to a few messages per billing cycle. Message and data rates may apply. Reply STOP to opt out, HELP for help. OOUStream never sends login credentials by SMS.
              </label>
            </div>
            <div>
