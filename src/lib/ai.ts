...
- On Firestick/Android TV: install Downloader app, enter code 2770918, install the Ooustream app
...
4. Open Downloader, enter code 2770918 in the URL bar
...
3. Open Downloader, enter code 2770918 in the URL bar
...
1. Open a browser on the phone and go to: http://aftv.news/2770918
...
5. After freeing space, go back to Downloader and re-enter the code **2770918**
...
6. Then re-enter the download code **2770918**
...
- The same download code **2770918** works for ALL Firestick devices
...
4. Then re-open Downloader and enter the code **2770918** again

=== Accidentally Deleted the App / Need to Reinstall ===
- No problem — just use the same code **2770918** in Downloader again
...
2. The download code is: **2770918** — enter this in the Downloader URL bar
...
4. In the URL bar of the Downloader app, enter the download code: **2770918**
...
- IMPORTANT: If the customer already has the Downloader app installed and ready, tell them they can skip straight to step 4 — just open Downloader and enter the code **2770918**. They should still grab their credentials first (step 1).
