...
- On Firestick/Android TV: install Downloader app, enter code 4294696, install the Ooustream app
...
4. Open Downloader, enter code 4294696 in the URL bar
...
3. Open Downloader, enter code 4294696 in the URL bar
...
1. Open a browser on the phone and go to: http://aftv.news/4294696
...
5. After freeing space, go back to Downloader and re-enter the code **4294696**
...
6. Then re-enter the download code **4294696**
...
- The same download code **4294696** works for ALL Firestick devices
...
4. Then re-open Downloader and enter the code **4294696** again

=== Accidentally Deleted the App / Need to Reinstall ===
- No problem — just use the same code **4294696** in Downloader again
...
2. The download code is: **4294696** — enter this in the Downloader URL bar
...
4. In the URL bar of the Downloader app, enter the download code: **4294696**
...
- IMPORTANT: If the customer already has the Downloader app installed and ready, tell them they can skip straight to step 4 — just open Downloader and enter the code **4294696**. They should still grab their credentials first (step 1).
