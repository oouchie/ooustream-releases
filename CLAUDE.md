...
**STATUS (2026-06-17): SECOND rejection — reason "consent cannot be a required condition for service or transaction completion." Optionality hardening shipped; owner to RESUBMIT with a dashboard-toggle screenshot. Holding until approved.** All site-side prerequisites are LIVE (consent toggle, `/sms-alerts` terms, broadened consent wording, opt-in confirmation send wired).
